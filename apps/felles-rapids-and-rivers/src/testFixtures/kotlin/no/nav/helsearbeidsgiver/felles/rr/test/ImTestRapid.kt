...
import no.nav.helsearbeidsgiver.felles.rr.publishMessage
...
class ImTestRapid : RapidsConnection() {
    ...
    fun publish(messageFields: Map<String, JsonElement>) {
        publishMessage(UUID.randomUUID().toString(), messageFields)
    }
