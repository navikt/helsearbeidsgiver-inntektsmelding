...
class ForespoerselForkastetLoeserTest : FunSpec({
    val testRapid = TestRapid()
    val mockPriProducer = mockk<PriProducer<JsonElement>>(relaxed = true)

    ForespoerselForkastetLoeser(testRapid, mockPriProducer)
    ...
    test("Ved notis om forkastet forespørsel publiseres behov om å hente notifikasjon-ID-er") {
