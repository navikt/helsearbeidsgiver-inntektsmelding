...
class TilgangskontrollIT : EndToEndTest() {
    ...
    @BeforeAll
    fun before() {
        forespoerselRepo.lagreForespørsel(FORESPØRSEL_ID_HAR_TILGANG, ORGNR_HAR_TILGANG)
        forespoerselRepo.lagreForespørsel(FORESPØRSEL_ID_IKKE_TILGANG, ORGNR_IKKE_TILGANG)
        coEvery {
