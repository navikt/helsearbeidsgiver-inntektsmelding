...
internal fun mockRedisClient(commands: RedisCommands<String, String>): RedisClient {
    val connection =
...
internal fun RedisCommands<String, String>.setupMock(mockStorageInit: Map<String, String?>): RedisCommands<String, String> =
    also {
