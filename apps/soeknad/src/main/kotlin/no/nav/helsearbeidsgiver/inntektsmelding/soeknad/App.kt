...
fun main() {
    ObjectRiver.connectToRapid {
        createHentSoeknaderRiver(createSoeknadKlient())
    }
}

fun createHentSoeknaderRiver(soeknadKlient: SoeknadKlient): List<HentSoeknaderRiver> =
    listOf(
        HentSoeknaderRiver(soeknadKlient),
    )
