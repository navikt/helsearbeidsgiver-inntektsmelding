...
class RedisStoreClassSpecificTest : FunSpec({
    ...
    test(RedisStoreClassSpecific::getAll.name) {
        ...
        redisStore.getAll(keysWithValues) shouldContainExactly mapOf(
    ...
    test("${RedisStoreClassSpecific::set.name} (ny og gammel)") {
        ...
        redisStore.getAll(keys) shouldContainExactly mapOf(
