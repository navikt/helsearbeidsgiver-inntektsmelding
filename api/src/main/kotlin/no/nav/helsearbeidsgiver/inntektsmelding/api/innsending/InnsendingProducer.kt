...
//                "@behov" to listOf(BehovType.JOURNALFOER.name, BehovType.ARBEIDSFORHOLD.name),
                "@behov" to listOf(BehovType.ARBEIDSFORHOLD.name), // kun send arbeidsforhold for å teste
                "@id" to uuid,
