...
class MapInntektsmeldingKtTest : FunSpec({
    ...
    context(::mapInntektsmelding.name) {
        ...
        test("fjerner ugyldige verdier fra 'fullLoennIArbeidsgiverPerioden' dersom AG utbetaler full lønn i AGP") {
            val forespoersel = Mock.forespoersel()
            val skjema = Mock.skjema().let {
                it.copy(
                    fullLønnIArbeidsgiverPerioden = it.fullLønnIArbeidsgiverPerioden?.copy(
            ...
            skjema.fullLønnIArbeidsgiverPerioden shouldBe FullLoennIArbeidsgiverPerioden(
                utbetalerFullLønn = true,
                begrunnelse = BegrunnelseIngenEllerRedusertUtbetalingKode.FravaerUtenGyldigGrunn,
                utbetalt = 4444.0
            )

            inntektsmelding.fullLønnIArbeidsgiverPerioden shouldBe FullLoennIArbeidsgiverPerioden(
                utbetalerFullLønn = true,
                begrunnelse = null,
                utbetalt = null
            )
        ...
        test("bruker forslag (fra Spleis) som bestemmende fraværsdag dersom AGP _ikke_ er påkrevd") {
            val forespoersel = Mock.forespoersel().utenPaakrevdAGP().let {
                it.copy(
                    bestemmendeFravaersdager = mapOf(
                        it.orgnr to 8.mai
                    )
        ...
        test("bruker fastsatt inntekt (fra Spleis) dersom inntekt _ikke_ er påkrevd") {
            ...
            inntektsmelding.inntekt shouldBe Inntekt(
                bekreftet = true,
        ...
        test("bruker tom refusjon dersom refusjon _ikke_ er påkrevd, selv om skjema påstår at AG utbetaler hele eller deler av sykepengene") {
            ...
            inntektsmelding.refusjon shouldBe Refusjon(
