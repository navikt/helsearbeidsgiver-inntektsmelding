...
class PersisterImLoeserTest {
    ...
    fun `skal publisere event for Inntektsmelding Mottatt`() {
        ...
        testRapid.sendJson(
            ...
            Key.ARBEIDSGIVER_INFORMASJON to PersonDato("Gudrun Arbeidsgiver", null, "").toJson(PersonDato.serializer()),
            Key.ARBEIDSTAKER_INFORMASJON to PersonDato("Toril Arbeidstaker", null, "").toJson(PersonDato.serializer()),
